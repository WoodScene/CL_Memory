...
if __name__=='__main__':
    ...
    for data_id in range(1):
        ...
        #parser.add_argument("--test_data_name", type=str, default="t5largelora15_TaSL_dataset_id_1_avgJGA", help = "-averaging")
        parser.add_argument("--test_data_name", type=str, default="t5largelora_multitask_dataset_id_7_avgPerf", help = "-averaging")
