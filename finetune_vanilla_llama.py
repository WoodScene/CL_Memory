...
def train(
    ...
    output_dir = os.path.join(output_path, model_name + "_vanilla_dataset_id_"+str(dataset_id), str(task_id)+"-"+dataset_order[task_id])
    ...
    if task_id == 0:
        ...
        last_checkpoint_dir = os.path.join(output_path, model_name + "_vanilla_dataset_id_"+str(dataset_id), str(task_id-1)+"-"+last_service_name)
